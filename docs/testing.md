...
- `docs/persistence.md` — atomic write and file-permission rules for persisted state
- `docs/concurrency.md` — mutation ordering and restart-visible side-effect rules
