...
X) agency clean deletes the worktree (and tmux) but does not delete git branches (local or remote), per the notes in README.md:1311. If you want the branch gone, you’d delete it manually with git.
