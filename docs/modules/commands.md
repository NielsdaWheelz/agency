...
- `internal/commands` owns ambient target inference and its precedence: explicit flag, current directory, then error.
...
- Commands may resolve targets, call the daemon or lower-level services, and render output.
